...
st.set_page_config(page_title="Heart Disease ML App", page_icon="❤️", layout="wide")
...
st.sidebar.download_button(
    "Download Sample CSV", sample_csv, "heartdisease_dataset.csv", "text/csv"
)
...
if uploaded_file:
    ...
    y_pred, y_prob = service.predict(X, model_name)
